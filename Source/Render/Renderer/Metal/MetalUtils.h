...
namespace Pharos
{
    namespace Render
    {
        ...
        inline MTLDepthStencilDescriptor* GetVulkanDepthStencilStateDesc(const DepthStencilStateDesc& desc)
        {
            const static MTLCompareFunction compareFunc[] = {
                MTLCompareFunctionNever,        //COMPARISON_NEVER
                MTLCompareFunctionLess,         //COMPARISON_LESS
                MTLCompareFunctionEqual,        //COMPARISON_EQUAL
                MTLCompareFunctionLessEqual,    //COMPARISON_LESS_EQUAL
                MTLCompareFunctionGreater,      //COMPARISON_GREATER
                MTLCompareFunctionNotEqual,     //COMPARISON_NOT_EQUAL
                MTLCompareFunctionGreaterEqual, //COMPARISON_GREATER_EQUAL
                MTLCompareFunctionAlways,       //COMPARISON_ALWAYS
            };
            
            const static MTLStencilOperation stencilOper[] = {
                MTLStencilOperationKeep,            //STENCIL_OP_KEEP
                MTLStencilOperationZero,            //STENCIL_OP_ZERO
                MTLStencilOperationReplace,         //STENCIL_OP_REPLACE
                MTLStencilOperationIncrementClamp,  //STENCIL_OP_INCR_SAT
                MTLStencilOperationDecrementClamp,  //STENCIL_OP_DECR_SAT
                MTLStencilOperationInvert,          //STENCIL_OP_INVERT
                MTLStencilOperationIncrementWrap,   //STENCIL_OP_INCR
                MTLStencilOperationDecrementWrap,   //STENCIL_OP_DECR
            };
            
            MTLDepthStencilDescriptor *depthStateDesc = [[MTLDepthStencilDescriptor alloc] init];
            depthStateDesc.depthCompareFunction = compareFunc[desc.depthFunc];
            depthStateDesc.depthWriteEnabled = desc.depthEnable ? YES : NO;
            
            depthStateDesc.frontFaceStencil.stencilCompareFunction = compareFunc[desc.frontStencilFunc];
            depthStateDesc.frontFaceStencil.stencilFailureOperation = stencilOper[desc.frontStencilFailOp];
            depthStateDesc.frontFaceStencil.depthFailureOperation = stencilOper[desc.frontStencilDepthFailOp];
            depthStateDesc.frontFaceStencil.depthStencilPassOperation = stencilOper[desc.frontStencilPassOp];
            depthStateDesc.frontFaceStencil.readMask = 0;
            depthStateDesc.frontFaceStencil.writeMask = 0;
            
            depthStateDesc.backFaceStencil.stencilCompareFunction = compareFunc[desc.backStencilFunc];
            depthStateDesc.backFaceStencil.stencilFailureOperation = stencilOper[desc.backStencilFailOp];
            depthStateDesc.backFaceStencil.depthFailureOperation = stencilOper[desc.backStencilDepthFailOp];
            depthStateDesc.backFaceStencil.depthStencilPassOperation = stencilOper[desc.backStencilPassOp];
            depthStateDesc.backFaceStencil.readMask = 0;
            depthStateDesc.backFaceStencil.writeMask = 0;
            
            return depthStateDesc;
        }
    
        inline void SetMetalRasterizerState(id<MTLRenderCommandEncoder> encoder, const RasterizerStateDesc& desc)
        {
            const static MTLTriangleFillMode triangleFillMode[] = {
                MTLTriangleFillModeLines, //FILL_WIREFRAME
                MTLTriangleFillModeFill, //FILL_SOLID
            };
            
            const static MTLCullMode cullMode[] = {
                MTLCullModeNone, //CULL_NONE
                MTLCullModeFront, //CULL_FRONT
                MTLCullModeBack, //CULL_BACK
            };
            
            [encoder setTriangleFillMode: triangleFillMode[desc.fillMode]];
            [encoder setCullMode: cullMode[desc.cullMode]];
            [encoder setFrontFacingWinding: desc.frontCounterClockwise ? MTLWindingCounterClockwise : MTLWindingClockwise];
        }
    }
}

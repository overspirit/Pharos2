...
namespace Pharos
{
	namespace Render
	{
		class MetalEffectLoader : public RenderEffectLoader
		{
		public:
			MetalEffectLoader(void);
			virtual ~MetalEffectLoader(void);

		protected:
			typedef bool (MetalEffectLoader::*LOAD_FUNC)(XmlNode* pNode);
		...
		protected:
			...
			vector<MetalRenderTechInfo*>	m_techInfoList;			
